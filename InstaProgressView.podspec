#
#  Be sure to run `pod spec lint InstaProgressViewSpec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author               = { "Ed" => "edsiniakov@aol.com" }
  # Or just: spec.author    = "Ed"
  # spec.authors            = { "Ed" => "edsiniakov@aol.com" }
  ...
  spec.source_files  = "InstaProgressView"
